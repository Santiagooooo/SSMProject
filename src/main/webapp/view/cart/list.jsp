...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:url value='/css/cart/list.css'/>">
    <script type="text/javascript">
            ...
            $(".jian").click(function () {
                ...
                if (quantity == 1) {
                    if (confirm("您是否真要删除该条目？")) {
                        location = "${pageContext.request.contextPath}/cartItem/batchDelete.do?cartItemIds=" + id;
                    }
                } else {
        ...
        function sendUpdateQuantity(id, quantity) {
            $.ajax({
                async: false,
                cache: false,
                url: "/SSMProject/cartItem/updateQuantity.do",
        ...
        */
        ...
        function batchDelete() {
            ...
            location = "${pageContext.request.contextPath}/cartItem/batchDelete.do?cartItemIds=" + cartItemIdArray.toString();
        }
...
<c:choose>
    ...
    <c:otherwise>
            ...
            <c:forEach items="${cartItemList }" var="cartItem">
                <tr align="center">
                    ...
                    <td align="left" width="70px">
                        <a class="linkImage"
                           href="${pageContext.request.contextPath}/book/load.do?bid=${cartItem.book.bid }">
                            <img border="0" width="54" align="top"
                                 src="${pageContext.request.contextPath}/images/${cartItem.book.image_b }"/>
                        </a>
                    </td>
                    <td align="left" width="400px">
                        <a href="${pageContext.request.contextPath}/book/load.do?bid=${cartItem.book.bid }">
                    ...
                    <td>
                        <input class="jian" type="button" value="-" id="${cartItem.cartItemId }Jian">
                        <input class="quantity" readonly="readonly" id="${cartItem.cartItemId }Quantity"
                               type="text" value="${cartItem.quantity }"/>
                        <input class="jia" type="button" value="+" id="${cartItem.cartItemId }Jia">
                    </td>
                    <td width="100px">
                <span class="price_n">
                &yen;<span class="subTotal" id="${cartItem.cartItemId }Subtotal">${cartItem.subtotal }</span>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/cartItem/batchDelete.do?cartItemIds=${cartItem.cartItemId }">删除</a>
                    </td>
                </tr>
            </c:forEach>
            <tr>
        ...
        <form id="jiesuanform" action="${pageContext.request.contextPath}/cartItem/loadCartItems.do"
              method="post">
