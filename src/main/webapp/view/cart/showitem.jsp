...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:url value='/css/cart/showitem.css'/>">
...
<body>
<form id="form1" action="${pageContext.request.contextPath}/order/createOrder.do"
      method="post">
    ...
    <table width="95%" align="center" cellpadding="0" cellspacing="0">
        ...
        <c:forEach items="${cartItems }" var="cartItem">
            <tr align="center">
                <td align="right">
                    <a class="linkImage"
                       href="${pageContext.request.contextPath}/view/book/desc.jsp">
                        <img
                                border="0" width="54" align="top"
                                src="<c:url value='/images/${cartItem.book.image_b }'/>"/>
                    </a>
                </td>
                <td align="left"><a
                        href="${pageContext.request.contextPath}/view/book/desc.jsp"><span>${cartItem.book.bname }</span></a>
                </td>
