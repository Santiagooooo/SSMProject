    ...
    <div id="content">
        <form target="_top" action="${pageContext.request.contextPath}/user/login.do" method="post"
            ...
            <table>
                ...
                <tr>
                    <td>
                        <input class="txtUsername input" placeholder="邮箱/用户名/手机号" name="loginname" id="loginname"
                ...
                <tr>
                    <td>
                        <input type="password" class="txtUserpwd input" placeholder="密码" name="loginpass" id="loginpass"
