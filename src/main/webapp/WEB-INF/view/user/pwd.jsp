...
<link rel="stylesheet" type="text/css"
    href="<c:url value='/${pageContext.request.contextPath}/css/css.css'/>">
<link rel="stylesheet" type="text/css"
    href="<c:url value='/${pageContext.request.contextPath}/css/user/pwd.css'/>">
...
<script src="<c:url value='/${pageContext.request.contextPath}/js/user/pwd.js'/>"></script>
</head>
...
<body>
 ...
 -->
    <section>
        <div class="div">
            <form action="<c:url value='/${pageContext.request.contextPath}/user/updatePassword.do'/>" method="post"
                target="_top">
                <table>
                    <tr>
                        <td class="textTd">&nbsp;</td>
